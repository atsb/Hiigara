...
flags |= SDL_WINDOW_FULLSCREEN_DESKTOP; // ATSB: This is put back to allow proper FULLSCREEN!
...
*/
	if (!(sdlwindow=SDL_CreateWindow("Homeworld", SDL_WINDOWPOS_UNDEFINED_DISPLAY(displayNum), SDL_WINDOWPOS_UNDEFINED_DISPLAY(displayNum),
		MAIN_WindowWidth, MAIN_WindowHeight, flags)))
	{
